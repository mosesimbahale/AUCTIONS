  ...
  <div class="container px-4 mx-auto">
    <div class="flex flex-wrap -mx-4 pb-24 mb-16 border-b border-gray-400">
      <div class="w-full lg:w-2/5 px-4 mb-16 lg:mb-0">
        <span class="text-lg text-blue-400 font-bold">We&apos;re Auctions</span>
        <h2 class="max-w-sm mt-8 mb-12 text-xl text-white font-bold font-heading">Thank you for your time</h2>
    ...
    <div class="md:flex justify-between">
      <p class="text-xs text-gray-200 mb-8 md:mb-0">&copy; 2022 Shuffle. All rights reserved.</p>
