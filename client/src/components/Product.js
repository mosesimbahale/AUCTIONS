    ...
    <div class="flex flex-wrap -mx-4">
        ...
        <div class="flex -mx-4 flex-wrap items-center justify-between lg:justify-start lg:items-start xl:items-center">
          <div class="w-full sm:w-auto min-w-max px-4 text-center flex sm:flex-col items-center justify-center">
            ...
            <a class="h-30 block mb-4 mr-2 sm:mr-0" href="#">
              <img class="h-full w-full" src="https://ik.imagekit.io/q5edmtudmz/FB_IMG_15658659197157667_wOd8n5yFyXI.jpg" alt=""/>
            </a>
            ...
            <a class="h-30 block mb-4 sm:mb-12 mr-4 sm:mr-0" href="#">
              <img class="h-full w-full" src="https://ik.imagekit.io/q5edmtudmz/FB_IMG_15658659197157667_wOd8n5yFyXI.jpg.png" alt=""/>
            </a>
          ...
          <div class="w-full sm:w-9/12 px-4">
            ...
            <p class="text-sm text-gray-900">Roll over image to zoom in</p>
          </div>
        </div>
      </div>
      <div class="w-full lg:w-1/2 px-4">
        <div class="max-w-md mb-6">
          ...
          <h2 class="mt-6 mb-4 text-2xl md:text-3xl lg:text-5xl font-heading font-medium">Apple iPhone 12 Pro (128GB) - Silver</h2>
