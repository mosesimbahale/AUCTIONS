...
const Sidebar = () => {
  return (
    <div>
      <section className="py-2 bg-blueGray-100">
            ...
            <div className="flex flex-wrap items-center justify-between -mx-4">
              ...
              <div className="w-full md:w-auto px-4">
                <div className="flex items-center">
                  ...
                  <a
                    className="inline-block py-2 px-6 m-4 text-sm leading-6 text-white font-medium tracking-tighter font-heading text-center bg-purple-500 hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-xl"
                    href="/signin"
                  >
                    All
                  </a>
